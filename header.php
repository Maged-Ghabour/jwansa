  ...
  <header class="navbar" id="navbar">
    <div class="container navbar__inner">
      ...
      <div class="navbar__actions" id="navActions">
        <a href="tel:<?php echo get_field('phone_number', 'option') ? get_field('phone_number', 'option') : '+966177222220'; ?>" class="navbar__phone" dir="ltr">
          ...
          <span><?php echo get_field('phone_display', 'option') ? get_field('phone_display', 'option') : '+966177222220'; ?></span>
        </a>
