  ...
  <header class="navbar" id="navbar">
    <div class="container navbar__inner">
      ...
      <div class="navbar__actions" id="navActions">
        <a href="tel:<?php echo jwansa_get_global_field('phone_number') ? jwansa_get_global_field('phone_number') : '+966177222220'; ?>" class="navbar__phone" dir="ltr">
          ...
          <span><?php echo jwansa_get_global_field('phone_display') ? jwansa_get_global_field('phone_display') : '+966177222220'; ?></span>
        </a>
